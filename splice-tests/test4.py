...
class test_splice_4(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest):
    ...
    def test_01_active_first_week(self):
        ...
        """
        self.splice_check_report(days_start=22, days_end=16, invalid=1)
    ...
    def test_04_inactive_second_week(self):
        ...
        Expecting 1 invalid subscription
        """
        self.splice_check_report(days_start=13, days_end=8, inactive=True, invalid=1)
    ...
    def test_05_active_third_week(self):
        ...
        """
        self.splice_check_report(days_start=7, days_end=1, current=1)
    ...
    def test_07_active_all_weeks(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=22, days_end=1, current=1)
    ...
    def test_12_inactive_future(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=-21, days_end=-31, inactive=True, current=1)
