...
class test_splice_2(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest):
    ...
    def test_01_active_first_week(self):
        ...
        """
        self.splice_check_report(days_start=15, days_end=8, current=1, state=['Active'])
    ...
    def test_02_inactive_first_week(self):
        ...
        """
        self.splice_check_report(days_start=15, days_end=8, state=['Inactive'])
    ...
    def test_03_consolidated_first_week(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=15, days_end=8, current=1, state=['Active', 'Inactive'])
    ...
    def test_06_consolidated_second_week(self):
        ...
        Expecting 1 invalid subscription
        """
        self.splice_check_report(days_start=7, days_end=1, invalid=1, state=['Active', 'Inactive'])
    ...
    def test_07_active_both_weeks(self):
        ...
        Expecting 1 invalid subscription
        """
        self.splice_check_report(days_start=15, days_end=1, invalid=1, state=['Active'])
    ...
    def test_08_inactive_both_week(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=15, days_end=1, state=['Inactive'])
    ...
    def test_09_consolidated_both_weeks(self):
        ...
        Expecting 1 invalid subscription
        """
        self.splice_check_report(days_start=15, days_end=1, invalid=1, state=['Active', 'Inactive'])
    ...
    def test_12_consolidated_history(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=31, days_end=21, state=['Active', 'Inactive'])
    ...
    def test_14_inactive_future(self):
        ...
        Expecting 1 invalid subscription
        """
        self.splice_check_report(days_start=-21, days_end=-31, state=['Inactive'], invalid=1)
