...
class test_splice_4(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest, Splice_has_WebUI):
    def _setup(self):
    ...
    def test_01_active_first_week(self):
        ...
        """
        Splice_has_WebUI.splice_check_report(days_start=22, days_end=16, invalid=1, state=['Active'])
    ...
    def test_03_consolidated_first_week(self):
        ...
        Expecting 1 invalid subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=22, days_end=16, invalid=1, state=['Active', 'Inactive'])
    ...
    def test_04_active_second_week(self):
        ...
        Expecting 0 subscriptions
        """
        Splice_has_WebUI.splice_check_report(days_start=13, days_end=8, state=['Active'])
    ...
    def test_05_inactive_second_week(self):
        ...
        Expecting 1 invalid subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=13, days_end=8, state=['Inactive'], invalid=1)
    ...
    def test_06_consolidated_second_week(self):
        ...
        Expecting 1 invalid subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=13, days_end=8, state=['Active', 'Inactive'], invalid=1)
    ...
    def test_07_active_third_week(self):
        ...
        """
        Splice_has_WebUI.splice_check_report(days_start=7, days_end=1, current=1, state=['Active'])
    ...
    def test_09_consolidatede_third_week(self):
        ...
        Expecting 1 current subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=7, days_end=1, current=1, state=['Active', 'Inactive'])
    ...
    def test_10_active_all_weeks(self):
        ...
        Expecting 1 current subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=22, days_end=1, current=1, state=['Active'])
    ...
    def test_12_consolidated_all_weeks(self):
        ...
        Expecting 1 current subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=22, days_end=1, current=1, state=['Active', 'Inactive'])
    ...
    def test_17_inactive_future(self):
        ...
        Expecting 1 current subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=-21, days_end=-31, state=['Inactive'], current=1)
