...
class test_splice_deleted_1(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest, Splice_has_WebUI):
    def _setup(self):
    ...
    def test_07_inactive_last_two_days(self):
        ...
        Expecting 0 subscriptions
        """
        Splice_has_WebUI.splice_check_report(days_start=1, days_end=0, state=['Inactive'])
    ...
    def test_09_consolidated_last_two_days(self):
        ...
        Expecting 0 subscriptions
        """
        Splice_has_WebUI.splice_check_report(days_start=1, days_end=0, state=['Active', 'Inactive', 'Deleted'])
    ...
    def test_10_active_four_days(self):
        ...
        Expecting 1 current subscription
        """
        Splice_has_WebUI.splice_check_report(days_start=4, days_end=1, current=1, state=['Active'])
    ...
    def test_11_inactive_four_days(self):
        ...
        Expecting 0 subscriptions
        """
        Splice_has_WebUI.splice_check_report(days_start=4, days_end=1, state=['Inactive'])
