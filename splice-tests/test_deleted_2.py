...
class test_splice_deleted_2(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest):
    def _setup(self):
    ...
    def test_02_active_first_two_days(self):
        ...
        """
        self.splice_check_report(days_start=4, days_end=3, current=1, state=['Active'])
    ...
    def test_03_inactive_first_two_days(self):
        ...
        """
        self.splice_check_report(days_start=4, days_end=3, state=['Inactive'])
    ...
    def test_04_deleted_first_two_days(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=4, days_end=3, state=['Deleted'])
    ...
    def test_05_consolidated_first_two_days(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=4, days_end=3, current=1, state=['Active', 'Inactive', 'Deleted'])
    ...
    def test_06_active_last_two_days(self):
        ...
        """
        self.splice_check_report(days_start=1, days_end=0, state=['Active'])
    ...
    def test_07_inactive_last_two_days(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=1, days_end=0, current=1, state=['Inactive'])
    ...
    def test_08_deleted_last_two_days(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=1, days_end=0, state=['Deleted'])
    ...
    def test_09_consolidated_last_two_days(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=1, days_end=0, current=1, state=['Active', 'Inactive', 'Deleted'])
    ...
    def test_10_active_four_days(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=4, days_end=0, current=1, state=['Active'])
    ...
    def test_11_inactive_four_days(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=4, days_end=0, state=['Inactive'])
    ...
    def test_12_deleted_four_days(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=4, days_end=-1, current=1, state=['Deleted'])
    ...
    def test_13_consolidated_four_days(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=4, days_end=-1, current=1, state=['Active', 'Inactive', 'Deleted'])
    ...
    def test_14_active_history(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=31, days_end=21, state=['Active'])
    ...
    def test_15_inactive_history(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=31, days_end=21, state=['Inactive'])
    ...
    def test_16_deleted_history(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=31, days_end=21, state=['Deleted'])
    ...
    def test_17_consolidated_history(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=31, days_end=21, state=['Active', 'Inactive', 'Deleted'])
    ...
    def test_19_inactive_future(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=-21, days_end=-31, state=['Inactive'])
    ...
    def test_20_deleted_future(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=-21, days_end=-31, state=['Deleted'])
    ...
    def test_21_consolidated_future(self):
        ...
        Expecting 0 subscriptions
        """
        self.splice_check_report(days_start=-21, days_end=-31, state=['Active', 'Inactive', 'Deleted'])
