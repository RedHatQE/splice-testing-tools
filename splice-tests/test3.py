...
class test_splice_3(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest):
    ...
    def test_01_active_first_week(self):
        ...
        """
        self.splice_check_report(days_start=22, days_end=16, current=1, state=['Active'])
    ...
    def test_03_consolidated_first_week(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=22, days_end=16, current=1, state=['Active', 'Inactive'])
    ...
    def test_06_consolidated_second_week(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=13, days_end=8, state=['Active', 'Inactive'], current=1)
    ...
    def test_10_active_all_weeks(self):
        ...
        Expecting 1 invalid subscription
        """
        self.splice_check_report(days_start=22, days_end=1, invalid=1, state=['Active'])
    ...
    def test_12_consolidated_all_weeks(self):
        ...
        Expecting 1 invalid subscription
        """
        self.splice_check_report(days_start=22, days_end=1, invalid=1, state=['Active', 'Inactive'])
