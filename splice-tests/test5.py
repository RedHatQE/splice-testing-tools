...
class test_splice_5(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest):
    ...
    def test_01_active_first_week(self):
        ...
        """
        self.splice_check_report(days_start=22, days_end=16, current=2)
    ...
    def test_03_active_second_week(self):
        ...
        """
        self.splice_check_report(days_start=13, days_end=8, current=1)
    ...
    def test_05_active_third_week(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=7, days_end=1, current=2)
    ...
    def test_07_active_all_weeks(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=22, days_end=1, current=2)
    ...
    def test_12_inactive_future(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=-21, days_end=-31, inactive=True, current=2)
