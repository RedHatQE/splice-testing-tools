...
class test_splice_5(SpliceTestcase, Splice_has_FAKE_SPACEWALK, Splice_has_Manifest):
    ...
    def test_01_active_first_week(self):
        ...
        """
        self.splice_check_report(days_start=22, days_end=16, current=2, state=['Active'])
    ...
    def test_03_consolidated_first_week(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=22, days_end=16, current=2, state=['Active', 'Inactive'])
    ...
    def test_04_active_second_week(self):
        ...
        """
        self.splice_check_report(days_start=13, days_end=8, current=1, state=['Active'])
    ...
    def test_05_inactive_second_week(self):
        ...
        Expecting 1 current subscription
        """
        self.splice_check_report(days_start=13, days_end=8, state=['Inactive'], current=1)
    ...
    def test_06_consolidated_second_week(self):
        ...
        """
        self.splice_check_report(days_start=13, days_end=8, state=['Active', 'Inactive'], current=2)
    ...
    def test_07_active_third_week(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=7, days_end=1, current=2, state=['Active'])
    ...
    def test_09_consolidated_third_week(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=7, days_end=1, current=2, state=['Active', 'Inactive'])
    ...
    def test_10_active_all_weeks(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=22, days_end=1, current=2, state=['Active'])
    ...
    def test_12_consolidated_all_weeks(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=22, days_end=1, current=2, state=['Active', 'Inactive'])
    ...
    def test_17_inactive_future(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=-21, days_end=-31, state=['Inactive'], current=2)
    ...
    def test_18_consolidated_future(self):
        ...
        Expecting 2 current subscriptions
        """
        self.splice_check_report(days_start=-21, days_end=-31, state=['Active', 'Inactive'], current=2)
